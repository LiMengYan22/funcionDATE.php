# miniPing.php
Pequeña porción en PHP de la **función DATE()**, para sacar fecha y hora por pantalla..
...
l minúscula: Una representación textual completa del día de la semana	Sunday hasta Saturday.
...
Vía: https://www.php.net/manual/es/function.date.php
